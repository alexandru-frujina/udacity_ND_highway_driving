    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Store the number of points stored previously
          ...
          {
            fastest_lane_from_current = current_lane;
          }
          else if (fastest_lane - current_lane > 0)
          {
          ...
          // Variables to describe the last point of the car
          double ref_x = car_x;
          double ref_y = car_y;
